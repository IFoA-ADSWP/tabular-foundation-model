...
funded proposal and execution scope, start with `docs/current/FULL_FINE_TUNING_PILOT_DESIGN.md`.
...
| F3 | Raw TabPFN already leads the competing baselines on `uslapseagent` — 0.9363 ROC AUC against 0.9271 (GLM) and 0.9297 (CatBoost). | current | `docs/current/PILOT_2_BRIEFING.md`, `docs/reference/FINE_TUNING_PILOT_RESULTS.md` |
